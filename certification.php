        ...
        <div class="content-section">
            ...
            <div class="content-item">
                <div class="kpi-tab">
                    ...
                    <button class="tab-button active" onclick="window.location.href='certification.php'">
            ...
            <div class="content-item" id="listAndButton">
                ...
                <div class="table-container">
                    <table class="custom-table">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM certification WHERE userID=" . $_SESSION["UID"] . " ORDER BY year ASC, sem ASC";
                            $result = mysqli_query($conn, $sql);
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            <a href="certification_edit.php?id=<?php echo $row["cert_id"]; ?>" class="edit-btn">
                                                <ion-icon name="create-outline"></ion-icon>
                                            </a>
                                            <a href="certification_delete.php?id=<?php echo $row["cert_id"]; ?>" 
                                               class="delete-btn" 
                                ...
                                echo '<tr><td colspan="7" class="no-records">No certifications recorded yet</td></tr>';
                            }
                            ?>
                        </tbody>
                    </table>
                ...
                <div class="form-container">
                    <form method="POST" action="certification_action.php" enctype="multipart/form-data" id="myForm">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="cert_name" rows="3" 
                                    placeholder="Enter the name or description of your certification" required></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="remark" rows="4" 
                                    placeholder="Enter any additional notes about the certification"></textarea>
                        </div>
