            ...
            <div class = "content-item">
                <div style="text-align: right;" id = "search">
                    <form action="my_challenge_search.php" method="post">
                        <input type="text" placeholder="Search.." name="search" id="searchInput" oninput="liveSearchChallenge()">
                ...
                <div class = "challenge-table">
                    <div style="padding:0 10px;" id="listAndButton">
                        <table border="1" width="100%" id="projectable">
                            ...
                            <?php
                            $sql = "SELECT * FROM challenge WHERE userID=" . $_SESSION["UID"] . " ORDER BY year ASC, sem ASC";
                            ...
                            if(mysqli_num_rows($result) > 0){
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo "</td><td>";
                                    echo '<a href="my_challenge_edit.php?id=' . $row["ch_id"] . '">Edit</a>&nbsp;|&nbsp;';
                                    echo '<a href="my_challenge_delete.php?id=' . $row["ch_id"] . '" onClick="return confirm(\'Delete?\');">Delete</a>';
                                    echo "</td>";
                                    echo "</tr>" . "\n\t\t";
                                    $numrow++;
                                }
                        ...
                        ?>
                            <input type="button" style = "margin-top: 20px" value="Add New" onclick="toggleFormVisibility()">
                        <?php
                        }
                        ?>
                    </div>
